...
// rendez-vous) + chat instantané avec l'équipe (design conservé).
// L'habillage extérieur (patient ou employé) est fourni par la page hôte.
...
// Lien « envoyer un document » adapté à l'espace où l'on se trouve.
function lienDocuments() {
