...
const PLAN = [
  ...
  { fichier: "09-reservations/patient-06-transport-medical.png", url: "/reserver/transport/besoin", persona: "patient", mobile: true, service: "transport", pleinePage: true },
  { fichier: "09-reservations/patient-07-aide-domicile.png", url: "/reserver/domicile/besoin", persona: "patient", mobile: true, service: "domicile", pleinePage: true },
  { fichier: "09-reservations/patient-08-livraison-medicaments.png", url: "/reserver/medicaments/besoin", persona: "patient", mobile: true, service: "medicaments", pleinePage: true },
