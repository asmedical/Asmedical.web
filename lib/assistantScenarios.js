...
const INTENTIONS = [
  ...
  },
  {
    ...
    fr: "Vous payez en espèces à la prestation, ou en ligne (CIB/EDAHABIA) quand c'est activé. Vos factures et reçus sont dans « Paiements & factures ».",
    ar: "تدفعون نقداً عند الخدمة، أو عبر الإنترنت (CIB/الذهبية) عند تفعيله. فواتيركم ووصولاتكم في « المدفوعات والفواتير ».",
    action: "paiements",
  },
  {
    id: "horaires",
