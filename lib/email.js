...
function gabarit(titre, corps) {
  ...
  <div style="max-width:520px;margin:0 auto;padding:24px">
    <div style="background:#0E6B3F;color:#fff;padding:16px 20px;border-radius:14px 14px 0 0;font-size:18px;font-weight:bold">ASM · Assistance Sociale Médicale</div>
