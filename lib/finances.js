...
export async function estimerPrestation({ service, date, dureeMin, typeTrajet, prioritaire, compteId, packId }) {
...
export async function facturerDemande(demande, { auteur = "Facturation automatique" } = {}) {
  ...
  if (!lignes) {
    ...
    lignes = construireLignes(demande, tarifs, { suffixe: ` — prestation n°${demande.id}` });
  }
